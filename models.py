...
class purchase_order(models.Model):
	...
	tipo_entrega = fields.Selection(selection=[('propio','Entrega en depósito &&Compañía'),('proveedor','Retiramos de Depósito del Proveedor'),('valle_soleado','Entrega en Valle Soleado')],\
